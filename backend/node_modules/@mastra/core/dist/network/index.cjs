...
var AgentNetwork = class extends chunkYEULQPUY_cjs.MastraBase {
  #instructions;
  #agents;
  #model;
  #routingAgent;
  #agentHistory = {};
  constructor(config) {
    super({ component: chunkSWW4EBUZ_cjs.RegisteredLogger.NETWORK, name: config.name || "AgentNetwork" });
    this.#instructions = config.instructions;
    this.#agents = config.agents;
    this.#model = config.model;
    this.#routingAgent = new chunkSLKAWVQR_cjs.Agent({
      name: config.name,
  ...
  getTools() {
    return {
      transmit: chunkU3L3NEOM_cjs.createTool({
        id: "transmit",
